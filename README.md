...
Oppgavebeskrivelsene kan brukes som hjelp til å navigere til riktige filer. Man kan åpne en **.md**-fil i et mer lesbart format ved å høyreklikke på filen i utforskeren, og velge **open preview**, eller trykke på symbolet vist under:
...
*Import med kloning* skjer med en annen veiviser, som  beskrevet på følgende wiki-side: <https://www.ntnu.no/wiki/pages/viewpage.action?pageId=234489370>. Lenken en da kan bruke til å klone er *<https://gitlab.stud.idi.ntnu.no/tdt4100/v2022/kont-2022>*.
...
*Import med kloning* skjer med en annen veiviser, som  beskrevet på følgende wiki-side:  <https://www.ntnu.no/wiki/display/tdt4100/Importere+kode+fra+git>. Lenken en da kan bruke til å klone er *<https://gitlab.stud.idi.ntnu.no/tdt4100/v2022/kont-2022>*.
